...
/***/ function(module, exports, __webpack_require__) {
	...
	var _riotRoute = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('execution-order', '<div>console.logに出力 {console.log(\'親 template\')}</div> <child></child>', '', '', function (opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('child', '<div>console.logに出力 {console.log(\'子 template\')}</div>', '', '', function (opts) {
	  this.on('before-mount', function () {
